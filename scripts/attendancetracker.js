...
btn1.addEventListener("click", () => {
  ...
  img.src =
    "https://trackingtime.co/wp-content/uploads/2020/05/Attendance-bot-ilus-01-2.svg";
  imgdiv.append(img);
...
btn2.addEventListener("click", () => {
  ...
  let img = document.createElement("img");
  img.src =
    "https://trackingtime.co/wp-content/uploads/2020/05/Attendance-bot-ilus-02-1.svg";
  imgdiv.append(img);
...
btn3.addEventListener("click", () => {
  ...
  let img = document.createElement("img");
  img.src =
    "https://trackingtime.co/wp-content/uploads/2020/05/Attendance-bot-ilus-03.svg";
  imgdiv.append(img);
