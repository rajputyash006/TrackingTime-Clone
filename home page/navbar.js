function navbar(){
    ...
    <div class="container-fluid">
      <a style="width:100%;" class="navbar-brand" href="./index.html"><img style="height:100%;width:50%;margin-left: 100px;"  src="https://trackingtime.co/wp-content/themes/trackingtime-v4/img/layout/header/logo.svg" alt=""></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <button class="btn btn-outline-success " style="margin-right: 10px;width:150px;" type="submit">TRY IT FREE</button>
